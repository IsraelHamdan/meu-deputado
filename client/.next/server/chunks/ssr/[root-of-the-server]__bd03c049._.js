...
const fetchDespesas = async (deputadoId, page = 1)=>{
    console.log("🚀 ~ fetchDespesas ~ deputadoId:", deputadoId);
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${baseUrl}/despesas/findAll/${deputadoId}?page=${page}`);
    console.log("🚀 ~ fetchDespesas ~ data:", data);
    return data;
};
function useDespesas(deputadoId, page = 1) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "Despesas",
            deputadoId,
